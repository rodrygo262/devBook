...
func PararDeSeguirUsuario(w http.ResponseWriter, r *http.Request) {
	...
	repositorio := repositorios.NovoRepositorioDeUsuarios(db)
	if erro = repositorio.PararDeSeguir(usuarioId, seguidor_id); erro != nil {
		respostas.Erro(w, http.StatusInternalServerError, erro)
		return
	}
...
// BuscarSeguidores busca todos seguidores do usuário
...
func BuscarSeguido(w http.ResponseWriter, r *http.Request) {
	...
	repositorio := repositorios.NovoRepositorioDeUsuarios(db)
	seguindo, erro := repositorio.BuscarSeguido(usuarioId)
	if erro != nil {
		respostas.Erro(w, http.StatusInternalServerError, erro)
		return
	}
